...
BooksRawRecyclerAdapter(var splist:ArrayList<SeriesProperties>,var itemClickListener:View.OnClickListener): RecyclerView.Adapter<BooksRawRecyclerAdapter.ItemViewHolder>() {
